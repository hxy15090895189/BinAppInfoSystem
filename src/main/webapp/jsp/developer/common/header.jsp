...
<title>APP开发者平台</title>
	...
	<!-- jquery-->
	<link href="${pageContext.request.contextPath }/statics/js/jquery.min.js">
				...
				<div class="left_col scroll-view">
					...
					<div class="profile">
						...
						<div class="profile_info">
							<span>Welcome,${sessionScope.list.get(0).devname}</span>
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								...
								<li><a><i class="fa fa-edit"></i> APP应用管理<span
									...
									<ul class="nav child_menu">
										<li><a href="${pageContext.request.contextPath}/dev/ListAll">APP信息列表</a>
										</li>
									</ul></li>
							</ul>
						</div>
...
<%
	...
	Object list =  session1.getAttribute("list");
	if (list==null){
		response.getWriter().write("<script>alert('你沒登陸就想進來是不是 傻！！！！！！！！');location.href='/index.jsp'</script>");
	}
%>